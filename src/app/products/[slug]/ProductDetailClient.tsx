            ...
            <div className="grid gap-4 sm:grid-cols-2 pt-2">
              <button
                onClick={() => {
                  ...
                  const widthSpec = product.specs.find(s => s.label.toLowerCase().includes('width'))?.value || 'Custom Width';
                  const typeSpec = product.specs.find(s => s.label.toLowerCase().includes('composition'))?.value || 'Custom';
